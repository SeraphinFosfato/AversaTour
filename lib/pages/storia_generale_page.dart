          ...
          children: [
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(top:5.0, bottom: 10, left: 10, right: 10),
                child: Text(
                  "Va detto, inoltre, che la decisione dei sovrani Giovanna I e Andrea d’Ungheria di insediarsi nel castello normanno eleggendolo a propria dimora, determinò uno sviluppo demografico ed economico della contea per la quale la fortezza divenne una struttura difensiva di notevole importanza strategica. Ed è proprio nel castello aversano che si consumò una delle pagine più cruente della storia del XIV secolo. Alcuni nobili napoletani infatti, capeggiati da Carlo di Durazzo, pretendente al trono di Napoli, forse in congiura con la stessa regina Giovanna I, uccisero, lanciandolo da una finestra con un cappio al collo, il principe consorte della sovrana angioina, Andrea d’Ungheria12. Il cruento assassinio del giovane principe non rimase impunito. Il fratello, il re Luigi d’Ungheria, con l'esercito scese in Italia e, dopo aver attraversato l'intera penisola, si fermò nel castello di Aversa. Qui tramò la sua vendetta contro Giovanna I, che scappò ad Avignone, e contro i nobili, i quali, invitati ad un pretestuoso banchetto di riconciliazioni, furono incarcerati e sommariamente processati. Addirittura a Carlo di Durazzo venne riservato la stessa morte e nello stesso luogo del principe ungherese13. La presenza della corte angioina, però, non portò solo tristi vicende. In questo periodo nacque la Real Casa dell'Annunziata (1315 circa), istituto benefico, orfanotrofio ed in seguito anche ospedale, che tanto ha segnato la vita e lo sviluppo sociale dell'intera comunità aversana14. Numerose furono poi le chiese ed i monasteri edificati per volere dei d’Angiò, come per esempio, la chiesa di San Luigi dei Francesi (oggi dedicata a san Domenico), fatta erigere dal nipote, re Carlo II d'Angiò, Sant’Agostino, Sant’Antonio, la Maddalena, San Pietro da Morrone e San Nicola solo per citarne alcune15. Il fervore edilizio della stagione angioina è testimoniato anche dalla creazione dell’ospizio regio nel Mercato del Sabato e l’impianto dell’ospedale dei Lebbrosi, nucleo del complesso della Maddalena16. Allo stesso periodo è ascrivibile l’erezione di San Giovanni Battista a Savignano e di S. Marta Maggiore e la rimodulazione di S. Giovanni Evangelista17. Alla metà del Trecento, invece, è possibile datare l’elevazione della cupola del Duomo di San Paolo, autentico omphalos di Aversa, la cui costruzione si deve al principe normanno Riccardo I, che ordinò l’inizio dei lavori nell’anno 1050, ed al figlio di costui, Giordano I, che li portò a termine nel 1090 circa18. La presenza della sovrana Giovanna d’Angiò, inoltre, riveste particolare importanza per le trasformazioni urbanistiche della città ma anche per i cambiamenti del costume della società dell’epoca. A tal proposito, per esempio, va ricordato che è proprio l’insediamento della nobiltà nelle adiacenze di San Domenico a determinare la creazione del sedile di San Luigi [ill.5], che adibito a luogo di convegno, fu utilizzato anche per amministrare la giustizia. È l'unico monumento medioevale del genere della città ancora esistente; gli altri, il Seggitiello di Piazza e il Sedile di Sant'Andrea, furono tutti demoliti19. Le dimore nobiliari del periodo conservano le caratteristiche dei palazzi normanni, la cui struttura rispecchia la necessità di poter gestire direttamente le attività agricole. Da ciò scaturiscono le dimensioni imponenti dell’ultimo piano, vero e proprio granaio destinato ad accogliere i cereali, già lavorati nel cortile. Analizzandola nella sua struttura essenziale, la casa si compone, così, di un fornice, che rende possibile l’attraversamento dei carri recanti le derrate alimentari, un androne, che è posto in immediata vicinanza alla corte, un piazzale di notevoli dimensioni, che costituisce il nucleo dell’attività familiare. Altri elementi caratteristici sono rappresentati dal forno, il pozzo, il lavatoio ed il cellaio con la relativa cantina. Gli alloggi più intimi sono ubicati al pianterreno (inferiora) e a quello soprastante (superiora), mentre una scala esterna porta alla corte della loggia, un ballatoio coperto, un corridoio interno che collega e disimpegna i vari ambienti. La struttura del pianterreno si connota per la presenza dei depositi per i prodotti agricoli, della dispensa, delle stalle e di tutti i servizi, fra i quali la cucina20. Tali caratteristiche, tipiche dell’età angioina, rappresenteranno le peculiarità architettoniche dei palazzi nei secoli XV e XVI. Va solo sottolineato un incremento nella costruzione di nuovi palazzi verso la via Seggio, che diventa un collegamento tra il castello normanno e la centrale cattedrale. In relazione al predetto allargamento della cinta muraria, va sottolineato come nel corso dei secoli, i privati abbiano utilizzato la struttura difensiva inglobandola nella conurbazione cittadina. Ciò è attestato dalla presenza di numerose riseghe, che testimoniano la trasformazione delle antiche torri di guardia in residenze private. Oltre alla già citata porta San Giovanni, sola superstite nella struttura complessiva, il fenomeno si evidenzia in un torrione posto in corrispondenza della porta S. Nicola. Un’ulteriore testimonianza è offerta da una monofora in via Ludovico Abenavolo (già via del Carmine) dove, in una fabbrica, al civico n. 10, la stessa è visibile nell’ordito murario, rivelando l’antica funzione di torre di guardia [ill. 6-7]. Con gli Aragonesi la città continuò a godere di alcuni privilegi, ma la sua importanza cominciò a declinare a partire dalla discesa di Carlo VIII di Francia, nel 149421, tanto che dal 150322 divenne un centro periferico e spopolato, ulteriormente aggravato dalle due epidemie di peste del 152623 e quella del 165624. Questo avvenimento causò la perdita di buona parte della popolazione. Il calo demografico e le ristrettezze economiche determinarono un freno dello sviluppo. Aversa ospitò Carlo III di Spagna tra l'aprile e il maggio del 1734, nel Palazzo Ventignano, dove ritornò nel 1738 con la moglie Maria Amalia di Sassonia25. La dominazione spagnola (1503) segnò, in ogni caso, il declino politico-sociale della città, che posta ai margini del vasto impero spagnolo, smarrì la sua antica autonomia26. Si deve alla “cattolica” corona spagnola, però, un notevole rinnovamento edilizio, che interessò la città, a partire dalla fine del Cinquecento. Fu in questo fervido periodo che la città si arricchì di numerosi edifici religiosi che, sostanziandosi nel nucleo centrale dell’impianto urbano, sortirono l’effetto di decentrare la popolazione verso le aree periferiche27.",
                  style: TextStyle(
                    fontSize: 20,
                    color: Colors.black,
                  ),
